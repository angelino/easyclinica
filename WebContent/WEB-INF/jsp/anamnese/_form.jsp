...
<form action="<%= request.getParameter("formAction") %>" method="post">
	...
	<fieldset>
      	<div>
			...
			<input type="text" name="anamnese.date" maxlength="50" required="required" value="<fmt:formatDate value="${anamnese.date.time}" pattern="dd/MM/yyyy" />" />
		</div>
      	<div>
          	<label class="title">Médico:<span>*</span></label>
          	<select name="anamnese.doctor.id">
