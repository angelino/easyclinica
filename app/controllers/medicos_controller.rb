class MedicosController < ApplicationController
	...
	def index
    @medicos = Medico.da(@clinica).ordenado_por_ativo.ordenado_por_nome.paginate :page => params[:page], :per_page => Config::QTD_POR_PAGINA
  end
  ...
  def destroy
	...
	def ativar_selecionados
		render :json => { :status => :ok, :nome => 'Murilo' }
	end
