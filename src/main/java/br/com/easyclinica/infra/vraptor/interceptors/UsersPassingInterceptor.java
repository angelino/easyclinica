...
@RequestScoped
@Intercepts
public class UsersPassingInterceptor implements Interceptor{

	private final LoggedUsersByTenant loggedUsers;
	private final Tenant tenant;

	public UsersPassingInterceptor(Tenant tenant, LoggedUsersByTenant loggedUsers) {
		this.tenant = tenant;
	...
	public boolean accepts(ResourceMethod method) {
		return tenant.getLoggedUser().isLogged();
	}
